    ...
    try:
        try:
            ...
            try:
                ...
                logger.error(f"Error fetching sitemap even with headers: {e_with_headers}")
        ...
        logger.error(f"An unexpected error occurred while processing sitemap {sitemap_url}: {e}")
...
@competitive_content_analyzer.route('/fetch_sitemap', methods=['POST'])
